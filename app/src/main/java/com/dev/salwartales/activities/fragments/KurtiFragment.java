 ...
 */
public class KurtiFragment extends Fragment {
  ...
  /*  public KurtiFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_kurti, container, false);

        rcview=v.findViewById(R.id.rv_featuredkurtigrid);
        rcviewlist=v.findViewById(R.id.rv_featuredkurtilist);

        lllistgrid=v.findViewById(R.id.ll_listgridkurti);
   ...
   return v;
    ...
    private void GetDatakurti() {


        String URL = "https://salwartales.com/rests2/api_3.php?category_id=60";
        try {
                                ...
                                if (jsono.getString("status").equals("success")) {
                                    ...
                                    for (int i = 0; i < jarray.length(); i++) {
                                        ...
                                        for (int j = 0; j < jarray1.length(); j++) {
                                            ...
                                            System.out.println("OOOLAAALAAAKURTI : " + Name + Price + Qty + FavStatus + ProId+Image);
